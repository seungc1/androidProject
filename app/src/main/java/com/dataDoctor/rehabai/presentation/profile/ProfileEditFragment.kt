...
import com.dataDoctor.rehabai.databinding.FragmentProfileEditBinding
...
class ProfileEditFragment : Fragment() {
    ...
    private fun updateGenderSelection(gender: String) {
        ...
        val primaryColor = ContextCompat.getColor(requireContext(), com.dataDoctor.rehabai.R.color.primaryColor)
        val onPrimaryColor = ContextCompat.getColor(requireContext(), com.dataDoctor.rehabai.R.color.white)
